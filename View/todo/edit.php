                    ...
                    <div class="col-lg-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Edit/Update Todo</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <?php
                            ...
                            <form id="todo" action="" method="post">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="title">Please select Category</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="status" class="form-control">
                                            ...
                                            <option <?= $data['status'] == 'p' ? ' selected="selected" ' : null; ?> value="p">Deactive</option>
                                            <option <?= $data['status'] == 's' ? ' selected="selected" ' : null; ?> value="s">In the process</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
